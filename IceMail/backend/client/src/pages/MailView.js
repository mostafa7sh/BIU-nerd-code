...
export default function MailView() {
  ...
  const handleEditDraft = () => {
    navigate(`/compose?draftId=${mail._id}`);
  };
      ...
      <div className="mail-view-container">
        <div className="mail-view-header">
          ...
          <div className="mail-view-meta">
            <img
              src={mail.fromProfilePic ? mail.fromProfilePic : DefaultAvatar}
              alt="Sender"
        ...
        <div className="mail-view-body">
          ...
          {mail.attachments.map((attachment, idx) => {
            const attachmentUrl = `data:${attachment.contentType};base64,${attachment.data}`;
            ...
            if (attachment.contentType.startsWith('image/')) {
              ...
              return (
                <a
                  key={idx}
                  href={attachmentUrl}
                  download={attachment.originalName || `attachment-${idx}`}
                  style={{ display: 'block', marginBottom: '10px' }}
                >
                  📎 Download {attachment.originalName || `Attachment ${idx + 1}`}
                </a>
              );
            }
          })}
